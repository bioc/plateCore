...
are modeled on the microarray data structure used in Bioconductor.  The \Robject{pbmcPlate} is comprised of an
...
of the 5 subfolders in the PBMC directory contains 96 fcs files.
