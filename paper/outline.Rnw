...
\title{plateCore Outline}
\author{straine}

\maketitle
\section*{Recent Related Publications}
\subsection*{flowCore, Cytometry}
...
. 
\subsection*{flowViz, Bioinformatics}
Using flowViz to make xyplots, ecdfplots, and time plots of GvHD data.

\subsection*{Quality Assessment of Ungated Flow Cytometry data in High Throughput experiments, Cytometry A, GvHD data}
Visualizing data: xyplots, histograms, ecdfplots, boxplots, and countour plots.\\
