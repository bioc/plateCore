...
threshold gating are performed in \Rpackage{plateCore}. The output is the fraction of positive, or expressing, cells for
...
surface markers. The raw data consists of signals from a PBMC preparation, including lymphocytes, monocytes, red blood cells, and cellular 
