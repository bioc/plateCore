...
are arrayed 3 per well (63 test wells), along with 30 isotype control wells and 3 unstained controls. Isotypes are used to
estimate 

 along
with isotype controls. Antibodies are arrayed 3 per well, 


Antibodies are arrayed 3 per well, and the data was compensated
