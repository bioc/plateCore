...
methods. We created a new package, called \Rpackage{plateCore}, that extends the
...
examined in detail and the isotype gate settings were found to be reasonble. In
...
easily verify that that isotype-based gate settings were consistent across the 5
...
isotype gate. Deviation from this line can indicate a either problem with the
